...
(function() {
		angular.module('axpress')
				.directive('mapAutocompleteAddressDestiny', mapAutocompleteAddressDestiny);

    mapAutocompleteAddressDestiny.$inject = ['$timeout'];

		function mapAutocompleteAddressDestiny($timeout) {
				return {
						restrict: 'EA',
						scope: {
								onPlaceChanged: "=",
						...
						templateUrl: 'templates/directives/mapAutocompleteAddressDestiny.html',
						controller: function($scope) {
								activate();
