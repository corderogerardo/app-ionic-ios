...
.config(['$stateProvider', '$urlRouterProvider', '$ionicCloudProvider', '$ionicConfigProvider',
    function($stateProvider, $urlRouterProvider, $ionicCloudProvider, $ionicConfigProvider) {
        $stateProvider
            .state('root', {
                url: '/',
